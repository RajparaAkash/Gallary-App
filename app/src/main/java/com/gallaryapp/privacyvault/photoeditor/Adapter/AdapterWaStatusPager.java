...
public class AdapterWaStatusPager extends FragmentStatePagerAdapter {

    private ArrayList<Media> media;
    private final SparseArray<Fragment> registeredFragments;

    public AdapterWaStatusPager(FragmentManager fm, ArrayList<Media> media) {
    ...
    public Fragment getItem(int pos) {
        ...
        return FileUtils.isVideo(media.getPath()) ? FragFileVideo.newInstance(media, pos) : FragFileImage.newInstance(media, pos);
    }
