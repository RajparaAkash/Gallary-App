...
import com.gallaryapp.privacyvault.photoeditor.Activity.ActAiBgRemover;
...
public class UCropActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.cropSaveTxt).setOnClickListener(view -> {
            cropAndSaveImage();
        });
    }
    ...
    private void addBlockingView() {
        if (mBlockingView == null) {
            ...
            lp.addRule(RelativeLayout.BELOW, R.id.toolbarLy);
    ...
    private void setOnBackPressed() {
        ...
        findViewById(R.id.cropCloseImg).setOnClickListener(view -> {
